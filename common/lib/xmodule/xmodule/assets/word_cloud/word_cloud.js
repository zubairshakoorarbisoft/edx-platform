...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = WordCloudMain;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_gettext__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__ = __webpack_require__(3);
...
WordCloudMain.prototype.drawWordCloud = function(response, words, bounds) {
    ...
    $.each(response.student_words, function(word, stat) {
        ...
        studentWordsKeys.push(__WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["interpolateHtml"](
            '{listStart}{startTag}{word}{endTag}{percent}{listEnd}',
            {
                listStart: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('<li>'),
                startTag: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('<strong>'),
                word: word,
                endTag: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('</strong>'),
                percent: percent,
                listEnd: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('</li>')
            }
        ).toString());
    });
    ...
    __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["setHtml"](
        cloudSectionEl.find('.your_words'),
        __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"](studentWordsStr)
    );

    __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["setHtml"](
        cloudSectionEl.find('.your_words').end().find('.total_num_words'),
        __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["interpolateHtml"](
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_gettext__["gettext"])('{start_strong}{total}{end_strong} words submitted in total.'),
            {
                start_strong: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('<strong>'),
                end_strong: __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["HTML"]('</strong>'),
    ...
    groupEl = d3.select('#' + cloudSectionEl.attr('id') + ' .word_cloud').append('svg')
            ...
            .attr('aria-describedby', function() {
                return __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["interpolateHtml"](
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_gettext__["gettext"])('text_word_{uniqueId} title_word_{uniqueId}'),
                    {
    ...
    groupEl
        ...
        .attr('id', function() {
            return __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["interpolateHtml"](
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_gettext__["gettext"])('title_word_{uniqueId}'),
                {
    ...
    groupEl
        ...
        .attr('id', function() {
            return __WEBPACK_IMPORTED_MODULE_1_edx_ui_toolkit_js_utils_html_utils__["interpolateHtml"](
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_gettext__["gettext"])('text_word_{uniqueId}'),
                {
                    uniqueId: generateUniqueId(cloudSectionEl.attr('id'), $(this).parent().data('id'))
                }
            );
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_word_cloud_main__ = __webpack_require__(1);


window.WordCloud = function(el) {
    new __WEBPACK_IMPORTED_MODULE_0_word_cloud_main__["a" /* WordCloudMain */](el);
};
...
(function(define) {
    'use strict';
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6), __webpack_require__(5), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, StringUtils) {
