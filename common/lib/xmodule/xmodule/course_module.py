...
class CourseFields(object):
    ...
    invitation_only_text = String(
        display_name=_("Invitation Only Message"),
        help=_(
            "If the course is invitation only then this message will be displayed at Course About page."
        ),
        default=None,
        scope=Scope.settings
    )
    ...
    course_for = String(
        display_name=_("Course Group"),
        help=_("Course is visible to selected groups only, default it's public"),
        default='public',
        scope=Scope.settings
    )
...
class CourseDescriptor(CourseFields, SequenceDescriptor, LicenseMixin):
    ...
    def course_category(self):
        ...
        return CourseCategory.get_course_category(self.id)
