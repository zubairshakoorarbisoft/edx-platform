...
from lms.djangoapps.verify_student.models import ManualVerification, VerificationDeadline
...
def set_id_verification_status(user):
    ...
    if not verifications:
        ...
        log.info("ManualVerification approved for: {username}".format(username=user.username))
