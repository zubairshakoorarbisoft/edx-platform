...
@task(bind=True)
def send_task_complete_email(self, task_name, task_state_text, dest_addr, detail_url, email, disable_email):
    """
    ...
    LOGGER.info('email and flag parameters: {} {}'.format(email, disable_email))
