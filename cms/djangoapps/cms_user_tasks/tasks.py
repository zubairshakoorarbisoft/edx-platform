...
@task(bind=True)
def send_task_complete_email(self, task_name, task_state_text, dest_addr, detail_url, email, disable_email, settings_email):
    """
    ...
    LOGGER.info('email, flag, setting var parameters: {} {} {}'.format(email, disable_email, settings_email))
