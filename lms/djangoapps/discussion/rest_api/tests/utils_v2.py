...
This module provides utility functions and classes for testing the Discussion API.
It is an adaptation of 'lms/djangoapps/discussion/rest_api/tests/utils.py' for use
with the forum v2 native APIs.
"""
...
class CommentsServiceMockMixin:
    ...
    def register_course_stats_response(self, course_key, stats, page, num_pages):
        ...
        self.mock_get_user_course_stats.return_value = {
            "user_stats": stats,
            "page": page,
            "num_pages": num_pages,
            "count": len(stats),
