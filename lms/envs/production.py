...
PANEL_ADMIN_LOGOUT_REDIRECT_URL = ENV_TOKENS.get('PANEL_ADMIN_LOGOUT_REDIRECT_URL', '/')

############### Fernet Encryption Key For Auto Login ####################
AUTO_LOGIN_ENCRYPTION_KEY = ENV_TOKENS.get('AUTO_LOGIN_ENCRYPTION_KEY', AUTO_LOGIN_ENCRYPTION_KEY)
EMAIL_UNSUBSCRIPTION_ENCRYPTION_KEY = ENV_TOKENS.get('EMAIL_UNSUBSCRIPTION_ENCRYPTION_KEY', EMAIL_UNSUBSCRIPTION_ENCRYPTION_KEY)
CHATLY_WIDGET_URL = ENV_TOKENS.get(
    'CHATLY_WIDGET_URL',
    CHATLY_WIDGET_URL
)
