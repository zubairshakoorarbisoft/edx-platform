...
DEFAULT_SITE_CREATION_COURSE_ID = ENV_TOKENS.get('DEFAULT_SITE_CREATION_COURSE_ID', None)

# Admin User Logout Redirect Setting
PANEL_ADMIN_LOGOUT_REDIRECT_URL = ENV_TOKENS.get('PANEL_ADMIN_LOGOUT_REDIRECT_URL', PANEL_ADMIN_LOGOUT_REDIRECT_URL)

# Data encryption keys for inter domain sensitive communication
ENCRYPTION_KEY_FERNET_CIPHER = ENV_TOKENS.get('ENCRYPTION_KEY_FERNET_CIPHER', ENCRYPTION_KEY_FERNET_CIPHER)
ENCRYPTION_SALT_FERNET_CIPHER = ENV_TOKENS.get('ENCRYPTION_SALT_FERNET_CIPHER', ENCRYPTION_SALT_FERNET_CIPHER)
