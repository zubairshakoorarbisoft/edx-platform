...
MIDDLEWARE = [
    ...
    # NPI checking Middleware
    'student.middleware.CheckNPIMiddleware',
]
...
INSTALLED_APPS = [
    ...
    # Course category
    'common.djangoapps.course_category.apps.CourseCategoryConfig',

    # report
    'lms.djangoapps.cme_reports.apps.CMEReportsConfig',
]
