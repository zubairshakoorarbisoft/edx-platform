...
ALLOWED_SITE_CONFIGURATIONS_OVERRIDE = [
    ...
    'EMAILS_CONFIG', 'DJANGO_SETTINGS_OVERRIDE', 'FEATURES', 'GTM_ID', 'GA_ID', 'MOBILE_ENABLED',
    'MOBILE_APP_CONFIG'
]
...
ENCRYPTION_KEY_FERNET_CIPHER = "ENCRYPTION_KEY_FERNET_CIPHER"
ENCRYPTION_SALT_FERNET_CIPHER = "ENCRYPTION_SALT_FERNET_CIPHER"
