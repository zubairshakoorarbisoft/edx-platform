    ...
    describe('Program Details Header View', function() {
            ...
            options = {
              programData: {
                ...
                staff: [
                  {
                    ...
                    bio: "Dr. Tester, PhD, RD, is an Associate Professor of Nutrition at the School of Nutrition and Health Promotion..",
                    profile_image: {},
                ...
                authoring_organizations: [
                  {
                    description: "<p>Learning University is home to leading creators, entrepreneurs, innovators and researchers.</p>",
                    tags: [
                      "contributor"
                    ],
                    ...
                    marketing_url: "someurl",
                    logo_image_url: "https://stage.edx.org/sites/default/files/school/image/logo/learnx-logo-200x101.png",
                  ...
                  },
                  {
                    ...
                    certificate_logo_image_url: null,
                    marketing_url: "someurl",
                    logo_image_url: "https://stage.edx.org/sites/default/files/school/image/logo/ritx-logo-200x101.png",
        ...
        it('should render the program heading', function() {
            ...
            expect(view.$('.program-heading-message').text().replace(/\s+/g, ' ').trim()).toEqual(
                "Track and plan your progress through the 3 courses in this program. To complete the program, you must earn a verified certificate for each course."
            );
        });
