                    ...
                    fields: [
                        ...
                        emailFieldView,
                        {
                            view: new AccountSettingsFieldViews.TextFieldView({
                                ...
                                valueAttribute: 'npi',
                                persistChanges: true,
                                helpMessage: gettext("You must enter your NPI if you don't have an NPI enter ten zeros to continue. ie. 0000000000"),  // eslint-disable-line max-len,
                            })
                        },
                        {
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('State/Region'),
                                valueAttribute: 'state',
                                options: fieldsData.state.options,
                                persistChanges: true
                            })
                        },
                        {
