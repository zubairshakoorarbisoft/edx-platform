...
from common.djangoapps.student.helpers import get_next_url_for_login_page, set_id_verification_status
...
def login_user(request):
    ...
    try:
        ...
        set_id_verification_status(possibly_authenticated_user)
