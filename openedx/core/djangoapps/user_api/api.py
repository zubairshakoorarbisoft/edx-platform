...
class RegistrationFormFactory(object):
    ...
    def _add_honor_code_field(self, form_desc, required=True):
        ...
        label = Text(_(
            ...
            terms_of_service_link_start=HTML(u"<a href='{terms_link}' rel='noopener' target='_blank'>").format(terms_link=terms_link),
        ...
        if not separate_honor_and_tos:
            ...
            label = Text(_(
                ...
                platform_name=configuration_helpers.get_value("PLATFORM_NAME", settings.PLATFORM_NAME),
                terms_of_service=terms_label,
                terms_of_service_link_start=HTML(u"<a href='{terms_url}' rel='noopener' target='_blank'>").format(terms_url=terms_link),
                terms_of_service_link_end=HTML("</a>"),
                privacy_policy_link_start=HTML(u"<a href='{pp_url}' rel='noopener' target='_blank'>").format(pp_url=pp_link),
    ...
    def _add_terms_of_service_field(self, form_desc, required=True):
        ...
        label = Text(_(u"I agree to the {platform_name} {tos_link_start}{terms_of_service}{tos_link_end}")).format(
            platform_name=configuration_helpers.get_value("PLATFORM_NAME", settings.PLATFORM_NAME),
            terms_of_service=terms_label,
            tos_link_start=HTML(u"<a href='{terms_link}' rel='noopener' target='_blank'>").format(terms_link=terms_link),
            tos_link_end=HTML("</a>"),
        )
